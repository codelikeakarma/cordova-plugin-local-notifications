...
export interface ILocalNotification {
    ...
    every?: string;
    /**
     * The interval time is extended by this. It's with number of you are using this and you reschedule the local notification as per your requirement.
     * Default: 1 (which means that the system triggers interval time of your local notification is one)
     */
    interval?: number;
    /**
